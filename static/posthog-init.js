...
//
// api_host points at THIS origin's /ingest path, which the Go app reverse-
// proxies to PostHog. That keeps every request same-origin so ad blockers
// (which block *.posthog.com directly) can't drop pageviews. The bootstrap's
// asset rewrite is a no-op against this host, so the library loads from
// <origin>/ingest/static/array.js — also proxied. ui_host keeps "open in
// PostHog" links pointing at the real app.
