...
<body>
  <header class="topbar"><a href="/" class="brand" style="text-decoration:none"><span class="dot"></span>bot<span class="slash">/</span>trade</a><div class="crumbs"><span class="here">Articles</span></div><nav><a href="/articles">Articles</a><a href="/leaderboard">Leaderboard</a><a href="/docs">Docs</a><a href="/account">Account</a></nav></header>
...
<body><header class="topbar"><a href="/" class="brand" style="text-decoration:none"><span class="dot"></span>bot<span class="slash">/</span>trade</a><div class="crumbs"><span class="here">Articles</span></div><nav><a href="/articles" style="color:var(--ink);font-weight:600">Articles</a><a href="/leaderboard">Leaderboard</a><a href="/docs">Docs</a><a href="/account">Account</a></nav></header>
